...
koneksi=DriverManager.getConnection("jdbc:mysql://localhost:3306/"+this.Database,this.Username,this.Password);
 ...
 public void tampilTabel(String Judul[],String SQL, JTable Tabel){
    try {
        ...
        JOptionPane.showMessageDialog(null,"Maaf Terjadi Kesalahan pada bagianmethod tampil Tabel : \n ["+e.toString() +"]");
    }
 }
 ...
 public void aturLebarKolom(JTable tabel,int baris[]){
    ...
    for (int i = 0; i < JumlahBaris-1; i++) {
        ...
        JOptionPane.showMessageDialog(null,"Maaf Terjadi Kesalahan pada bagianmethod aturLebarKolom : \n ["+e.toString() +"]");
    }
}
 ...
 public void hapusData(String SQL){
    ...
    JOptionPane.showMessageDialog(null,"Maaf Terjadi Kesalahan pada bagian method hapus Data : \n ["+e.toString() +"]");
    }
}
